...
CLOUD_SIMULATOR_ENABLED_VALUE="${CLOUD_SIMULATOR_ENABLED:-false}"
CLOUD_SIMULATOR_HOME_COUNT_VALUE="${CLOUD_SIMULATOR_HOME_COUNT:-${HOSTED_HOMES_VALUE}}"
CLOUD_SIMULATOR_PERIOD_SECONDS_VALUE="${CLOUD_SIMULATOR_PERIOD_SECONDS:-60}"
...
TF_ARGS=(
  ...
  -var "cloud_simulator_enabled=${CLOUD_SIMULATOR_ENABLED_VALUE}"
  -var "cloud_simulator_home_count=${CLOUD_SIMULATOR_HOME_COUNT_VALUE}"
  -var "cloud_simulator_period_seconds=${CLOUD_SIMULATOR_PERIOD_SECONDS_VALUE}"
...
echo
echo "AWS hosted fleet is ready."
echo "Outputs: ${INFRA_DIR}/.aws-demo-outputs.json"
echo "Run cloud dashboard: ${DEMO_DIR}/scripts/run_cloud_demo.sh"
